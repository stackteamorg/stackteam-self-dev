...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('abstrak/css/vendor/sal.css') }}">
    <link rel="stylesheet" href="{{ asset('abstrak/css/vendor/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('abstrak/css/vendor/green-audio-player.min.css') }}">
    ...
    <div id="main-wrapper" class="main-wrapper">
                ...
                <div class="container">
                    <div class="header-navbar">
                        <div class="header-logo">
                            <a href="index-1.html"><img class="light-version-logo" src="{{ asset('abstrak/media/logo.svg') }}" alt="logo"></a>
                            <a href="index-1.html"><img class="dark-version-logo" src="{{ asset('abstrak/media/logo-3.svg') }}" alt="logo"></a>
                            <a href="index-1.html"><img class="sticky-logo" src="{{ asset('abstrak/media/logo-2.svg') }}" alt="logo"></a>
                        </div>
        ...
        <section class="banner banner-style-4">
            <div class="container">
                ...
                <div class="banner-thumbnail">
                    <div class="large-thumb" data-sal="slide-left" data-sal-duration="800" data-sal-delay="400">
                        <img class="paralax-image" src="{{ asset('abstrak/media/banner/banner-thumb-7.png') }}" alt="Shape">
                    </div>
                </div>
            ...
            <ul class="list-unstyled shape-group-19">
                <li class="shape shape-1" data-sal="slide-down" data-sal-duration="500" data-sal-delay="100">
                    <img src="{{ asset('abstrak/media/others/bubble-29.png') }}" alt="Bubble">
                </li>
                <li class="shape shape-2" data-sal="slide-left" data-sal-duration="500" data-sal-delay="200">
                    <img src="{{ asset('abstrak/media/others/line-7.png') }}" alt="Bubble">
                </li>
            </ul>
        </section>
        <!--=====================================-->
        ...
        <section class="section section-padding-equal bg-color-ship-gray">
            <div class="container">
                ...
                <div class="project-add-banner" data-sal="slide-up" data-sal-duration="1000">
                    <div class="content">
                        ...
                        <h3 class="title"><a href="single-portfolio.html">Godaddy- Online platform and website design</a></h3>
                        <div class="brand-logo">
                            <img src="{{ asset('abstrak/media/project/godaddy.png') }}" alt="Godaddy">
                        </div>
                    </div>
                    <div class="thumbnail">
                        <img src="{{ asset('abstrak/media/project/mobile-mockup.png') }}" alt="Mockup">
                    </div>
                </div>
                <div class="row row-45">
                        ...
                        <div class="project-grid project-style-2">
                            <div class="thumbnail">
                                <a href="single-portfolio.html">
                                    <img src="{{ asset('abstrak/media/project/project-7.png') }}" alt="project">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-6" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="200">
                        <div class="project-grid project-style-2">
                            <div class="thumbnail">
                                <a href="single-portfolio.html">
                                    <img src="{{ asset('abstrak/media/project/project-8.png') }}" alt="project">
                                </a>
                            </div>
                            <div class="content">
                                <span class="subtitle">ios, design</span>
                                <h3 class="title"><a href="single-portfolio.html">Cynic Agency</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" data-sal="slide-up" data-sal-duration="1000">
                        <div class="project-grid project-style-2">
                            <div class="thumbnail">
                                <a href="single-portfolio.html">
                                    <img src="{{ asset('abstrak/media/project/project-9.png') }}" alt="project">
                                </a>
                            </div>
                            <div class="content">
                                <span class="subtitle">ios, design</span>
                    ...
                    <div class="col-md-6" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="200">
                        <div class="project-grid project-style-2">
                            <div class="thumbnail">
                                <a href="single-portfolio.html">
                                    <img src="{{ asset('abstrak/media/project/project-12.png') }}" alt="project">
                                </a>
                            </div>
                            <div class="content">
                                <span class="subtitle">ios, design</span>
            ...
            <ul class="list-unstyled shape-group-10">
                <li class="shape shape-1"><img src="{{ asset('abstrak/media/others/circle-1.png') }}" alt="Circle"></li>
                <li class="shape shape-2"><img src="{{ asset('abstrak/media/others/line-3.png') }}" alt="Circle"></li>
                <li class="shape shape-3"><img src="{{ asset('abstrak/media/others/bubble-5.png') }}" alt="Circle"></li>
            </ul>
        </section>
        <!--=====================================-->
        ...
        <section class="section section-padding">
                ...
                <div class="row">
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100">
                        <div class="testimonial-grid active">
                            <span class="social-media"><img src="{{ asset('abstrak/media/icon/yelp-2.png') }}" alt="Yelp"></span>
                            ...
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="{{ asset('abstrak/media/testimonial/testimonial-1.png') }}" alt="Google Review">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="200">
                        <div class="testimonial-grid">
                            <span class="social-media"><img src="{{ asset('abstrak/media/icon/google-2.png') }}" alt="google"></span>
                            <p>“ Donec metus lorem, vulputate
                                at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. ”</p>
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="{{ asset('abstrak/media/testimonial/testimonial-2.png') }}" alt="Google Review">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300">
                        <div class="testimonial-grid">
                            <span class="social-media"><img src="{{ asset('abstrak/media/icon/fb-2.png') }}" alt="Facebook"></span>
                            <p>“ Donec metus lorem, vulputate
                                at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. ”</p>
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="{{ asset('abstrak/media/testimonial/testimonial-3.png') }}" alt="Google Review">
                                </div>
                                <div class="content">
            ...
            <ul class="shape-group-4 list-unstyled">
                <li class="shape-1"><img src="{{ asset('abstrak/media/others/bubble-1.png') }}" alt="Bubble"></li>
            </ul>
        </section>
        <!--=====================================-->
        <!--=        Brand Area Start       	=-->
        ...
        <section class="section section-padding-equal">
                ...
                <div class="row g-0">
                    <div class="col-xl-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list active">
                            <div class="post-thumbnail">
                                <a href="single-blog-2.html"><img src="{{ asset('abstrak/media/blog/blog-1.png') }}" alt="Blog Post"></a>
                            </div>
                    ...
                    <div class="col-xl-6" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list border-start">
                            <div class="post-thumbnail">
                                <a href="single-blog-3.html"><img src="{{ asset('abstrak/media/blog/blog-2.png') }}" alt="Blog Post"></a>
                            </div>
                            <div class="post-content">
            ...
            <ul class="shape-group-1 list-unstyled">
                <li class="shape shape-1"><img src="{{ asset('abstrak/media/others/bubble-1.png') }}" alt="bubble"></li>
                <li class="shape shape-2"><img src="{{ asset('abstrak/media/others/line-1.png') }}" alt="bubble"></li>
                <li class="shape shape-3"><img src="{{ asset('abstrak/media/others/line-2.png') }}" alt="bubble"></li>
                <li class="shape shape-4"><img src="{{ asset('abstrak/media/others/bubble-2.png') }}" alt="bubble"></li>
            </ul>
        </section>
        <!--=====================================-->
        ...
        <section class="section call-to-action-area">
                ...
                <div class="call-to-action">
                    ...
                    <div class="thumbnail">
                        <div class="larg-thumb" data-sal="zoom-in" data-sal-duration="600" data-sal-delay="100">
                            <img class="paralax-image" src="{{ asset('abstrak/media/others/chat-group.png') }}" alt="Chat">
                        </div>
                        <ul class="list-unstyled small-thumb">
                            <li class="shape shape-1" data-sal="slide-right" data-sal-duration="800" data-sal-delay="400">
                                <img class="paralax-image" src="{{ asset('abstrak/media/others/laptop-poses.png') }}" alt="Laptop">
                            </li>
                            <li class="shape shape-2" data-sal="slide-left" data-sal-duration="800" data-sal-delay="300">
                                <img class="paralax-image" src="{{ asset('abstrak/media/others/bill-pay.png') }}" alt="Bill">
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <ul class="list-unstyled shape-group-9">
                <li class="shape shape-1"><img src="{{ asset('abstrak/media/others/bubble-12.png') }}" alt="Comments"></li>
                <li class="shape shape-2"><img src="{{ asset('abstrak/media/others/bubble-16.png') }}" alt="Comments"></li>
                <li class="shape shape-3"><img src="{{ asset('abstrak/media/others/bubble-13.png') }}" alt="Comments"></li>
                <li class="shape shape-4"><img src="{{ asset('abstrak/media/others/bubble-14.png') }}" alt="Comments"></li>
                <li class="shape shape-5"><img src="{{ asset('abstrak/media/others/bubble-16.png') }}" alt="Comments"></li>
                <li class="shape shape-6"><img src="{{ asset('abstrak/media/others/bubble-15.png') }}" alt="Comments"></li>
                <li class="shape shape-7"><img src="{{ asset('abstrak/media/others/bubble-16.png') }}" alt="Comments"></li>
            </ul>
        </section>
        <!--=====================================-->
        <!--=        Footer Area Start       	=-->
